...
function environment() {
  ...
  let hostname  = process.env.HOSTNAME; // For sandbox use 'https://api.sandbox.paypal.com'

  return new paypal.core.SandboxEnvironment(clientId, clientSecret, hostname);
}
